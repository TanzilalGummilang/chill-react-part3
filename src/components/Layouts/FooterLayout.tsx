export default function FooterLayout() {
  return (
    <footer className="container py-8 lg:py-14 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 border-t border-other__outline-border/23">
...
const genres = [
  ...
  { name: "Fantasi Ilmiah & Fantasi", href: "fantasi-ilmiah-fantasi" },
